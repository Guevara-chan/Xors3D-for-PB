...
Prototype.L _xLoadBrush_(path.S, flags.L, xScale.F, yScale.F)
Global xLoadBrush_._xLoadBrush_ = GetFunction(*Library_, "_xLoadBrush@16")
Prototype.L _xLoadBrush(path.S, flags.L, xScale.F, yScale.F)
...
Prototype.L _xBrushName(brush.L, name.S)
...
Prototype.L _xSetEffectMatrixWithElements_(entity.L, name.S, m11.F, m12.F, m13.F, m14.F, m21.F, m22.F, m23.F, m24.F, m31.F, m32.F, m33.F, m34.F, m41.F, m42.F, m43.F, m44.F, layer.L)
...
Prototype.L _xSetEffectMatrixWithElements(entity.L, name.S, m11.F, m12.F, m13.F, m14.F, m21.F, m22.F, m23.F, m24.F, m31.F, m32.F, m33.F, m34.F, m41.F, m42.F, m43.F, m44.F, layer.L)
Global xSetEffectMatrixWithElements._xSetEffectMatrixWithElements = GetFunction(*Library_, "xSetEffectMatrixWithElements")
Prototype.L _xSetEffectMatrix_(entity.L, name.S, matrix.L, layer.L)
Global xSetEffectMatrix_._xSetEffectMatrix_ = GetFunction(*Library_, "_xSetEffectMatrix@16")
Prototype.L _xSetEffectMatrix(entity.L, name.S, matrix.L, layer.L)
Global xSetEffectMatrix._xSetEffectMatrix = GetFunction(*Library_, "xSetEffectMatrix")
Prototype.L _xSurfaceEffectMatrix_(surface.L, name.S, matrix.L, layer.L)
Global xSurfaceEffectMatrix_._xSurfaceEffectMatrix_ = GetFunction(*Library_, "_xSurfaceEffectMatrix@16")
Prototype.L _xSurfaceEffectMatrix(surface.L, name.S, matrix.L, layer.L)
Global xSurfaceEffectMatrix._xSurfaceEffectMatrix = GetFunction(*Library_, "xSurfaceEffectMatrix")
Prototype.L _xSurfaceEffectMatrixWithElements_(surface.L, name.S, m11.F, m12.F, m13.F, m14.F, m21.F, m22.F, m23.F, m24.F, m31.F, m32.F, m33.F, m34.F, m41.F, m42.F, m43.F, m44.F, layer.L)
...
Prototype.L _xSurfaceEffectMatrixWithElements(surface.L, name.S, m11.F, m12.F, m13.F, m14.F, m21.F, m22.F, m23.F, m24.F, m31.F, m32.F, m33.F, m34.F, m41.F, m42.F, m43.F, m44.F, layer.L)
...
Prototype.L _xSetFXTechnique(effect.L, name.S)
...
Prototype.L _xNameEntity(entity.L, name.S)
...
Prototype.L _xFindChild(entity.L, name.S)
...
Prototype.L _xMountPackFile_(path.S, mountpoint.S, password.S)
Global xMountPackFile_._xMountPackFile_ = GetFunction(*Library_, "_xMountPackFile@12")
Prototype.L _xMountPackFile(path.S, mountpoint.S, password.S)
...
Prototype.L _xWriteString(file.L, value.S)
Global xWriteString._xWriteString = GetFunction(*Library_, "_xWriteString@8")
Prototype.L _xWriteLine_(file.L, value.S, ls_flag.L)
Global xWriteLine_._xWriteLine_ = GetFunction(*Library_, "_xWriteLine@12")
Prototype.L _xWriteLine(file.L, value.S, ls_flag.L)
Global xWriteLine._xWriteLine = GetFunction(*Library_, "xWriteLine")
Prototype.L _xLoadFont_(name.S, height.L, bold.L, italic.L, underline.L, fontface.S)
Global xLoadFont_._xLoadFont_ = GetFunction(*Library_, "_xLoadFont@24")
Prototype.L _xLoadFont(name.S, height.L, bold.L, italic.L, underline.L, fontface.S)
Global xLoadFont._xLoadFont = GetFunction(*Library_, "xLoadFont")
Prototype.L _xText_(x.F, y.F, textString.S, centerx.L, centery.L)
Global xText_._xText_ = GetFunction(*Library_, "_xText@20")
Prototype.L _xText(x.F, y.F, textString.S, centerx.L, centery.L)
...
Prototype.L _xSaveBuffer(buffer.L, path.S)
...
Prototype.L _xLoadBuffer(buffer.L, path.S)
...
Prototype.L _xSetEngineSetting(parameter.S, value.S)
Global xSetEngineSetting._xSetEngineSetting = GetFunction(*Library_, "_xSetEngineSetting@8")
Prototype.I _xGetEngineSetting(parameter.S)
...
Prototype.L _xLoadAnimImage(path.S, width.L, height.L, startFrame.L, frames.L)
Global xLoadAnimImage._xLoadAnimImage = GetFunction(*Library_, "_xLoadAnimImage@20")
Prototype.L _xSaveImage_(image.L, path.S, frame.L)
Global xSaveImage_._xSaveImage_ = GetFunction(*Library_, "_xSaveImage@12")
Prototype.L _xSaveImage(image.L, path.S, frame.L)
...
Prototype.L _xCreateLog_(target.L, level.L, filename.S, cssfilename.S)
Global xCreateLog_._xCreateLog_ = GetFunction(*Library_, "_xCreateLog@16")
Prototype.L _xCreateLog(target.L, level.L, filename.S, cssfilename.S)
...
Prototype.L _xLoadMesh_(path.S, parent.L)
Global xLoadMesh_._xLoadMesh_ = GetFunction(*Library_, "_xLoadMesh@8")
Prototype.L _xLoadMesh(path.S, parent.L)
Global xLoadMesh._xLoadMesh = GetFunction(*Library_, "xLoadMesh")
Prototype.L _xLoadMeshWithChild_(path.S, parent.L)
...
Prototype.L _xLoadAnimMesh_(path.S, parent.L)
Global xLoadAnimMesh_._xLoadAnimMesh_ = GetFunction(*Library_, "_xLoadAnimMesh@8")
Prototype.L _xLoadAnimMesh(path.S, parent.L)
...
Prototype.L _xSaveMesh(entity.L, path.S)
...
Prototype.L _xLoadPostEffect(path.S)
...
Prototype.L _xSetPostEffect_(index.L, postEffect.L, technique.S)
Global xSetPostEffect_._xSetPostEffect_ = GetFunction(*Library_, "_xSetPostEffect@12")
Prototype.L _xSetPostEffect(index.L, postEffect.L, technique.S)
...
Prototype.L _xSetShadowShader(path.S)
...
Prototype.L _xLoadSprite_(path.S, flags.L, parent.L)
Global xLoadSprite_._xLoadSprite_ = GetFunction(*Library_, "_xLoadSprite@12")
Prototype.L _xLoadSprite(path.S, flags.L, parent.L)
...
Prototype.L _xLoadTerrain_(path.S, parent.L)
Global xLoadTerrain_._xLoadTerrain_ = GetFunction(*Library_, "_xLoadTerrain@8")
Prototype.L _xLoadTerrain(path.S, parent.L)
...
Prototype.L _xLoadTerrainTexture(path.S)
...
Prototype.L _xLoadTexture_(path.S, flags.L)
Global xLoadTexture_._xLoadTexture_ = GetFunction(*Library_, "_xLoadTexture@8")
Prototype.L _xLoadTexture(path.S, flags.L)
...
Prototype.L _xLoadAnimTexture(path.S, flags.L, width.L, height.L, startFrame.L, frames.L)
...
Prototype.L _xOpenMovie(path.S)
